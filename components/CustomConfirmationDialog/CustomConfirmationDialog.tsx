        ...
        <div className="grid grid-cols-1 p-5">
            ...
            <div className='flex flex-row-reverse gap-1'>
                {props?.variant === 'danger' ? <button
                    className="cursor-pointer focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900 flex gap-1"
