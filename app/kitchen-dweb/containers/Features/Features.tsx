            ...
            <div className="flex container w-full mx-auto max-w-7xl gap-10">
                {props.item.gallery.map((feature, i) => (
                    ...
                    >
                        ...
                        >
                            <div className="text-white text-2xl absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center">Did your kichen <span className='font-bold italic'>shower</span> today?</div>
                        </div>
                    </div>
                ))}
            </div>
