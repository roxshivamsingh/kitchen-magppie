        ...
        >
            ...
            <div className="relative z-10 flex flex-col items-start justify-between h-full text-white">
                <div className="flex items-center justify-between w-full px-6 py-4">
                    <h1 className="text-white font-bold text-xl sm:text-4xl lg:text-3xl cursor-pointer">
                        MAGPPIE
                    </h1>
                    <GiHamburgerMenu className="h-6 w-6 sm:h-10 sm:w-10 cursor-pointer" />
                </div>
                <div className="text-3xl sm:text-4xl mb-40 pl-6 sm:ml-8 p-4">
