    ...
    return (
        <div className="bg-[#5d4e3e] text-white py-40 px-10 flex flex-col justify-start w-full">
            ...
            <div className="flex justify-start items-start">
                <div className="text-3xl cursor-pointer mt-6 bg-brown-600 text-white font-light uppercase py-6 px-6 border border-white rounded-full flex items-center justify-start hover:bg-brown-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brown-500">
