...
const ContactSection = () => {
    ...
    return (
        <div
            className="relative w-full bg-cover h-[600px]"
            ...
            <div className="relative z-10 flex flex-col items-start justify-between h-full w-full">
                ...
                <div className="flex items-center justify-center w-full h-screen container mx-auto max-w-7xl text-center">
                    <div className="flex flex-col">
                        ...
                        <button
                            type="button"
                            className="space-y-4 text-2xl z-10 uppercase font-normal cursor-pointer mt-6 bg-brown-600 text-black bg-white border border-white px-4 py-4 rounded-full ml-3"
                            onClick={() => {
                                setToggle((prev) => ({
                                    ...prev,
