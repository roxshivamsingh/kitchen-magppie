...
export const galleries = [
    ...
    { id: 6, src: gallerySix, colSpan: 1, rowSpan: 2, height: 1 }, //common
    { id: 7, src: gallerySeven, colSpan: 1, rowSpan: 2, height: 1 }, //common
    { id: 8, src: galleryEight, colSpan: 2, rowSpan: 1 },
