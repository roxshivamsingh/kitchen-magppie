    ...
    return (
        <div className="flex flex-col justify-center items-center mx-20" id="About">
            <div
                ...
                className="w-full flex justify-center items-center focus:outline-none my-8 bg-[#1e1e1e] py-8 max-w-xl shadow-xl text-white text-3xl p-2 rounded-full font-thin cursor-pointer"
                onClick={onToggle}
            >
