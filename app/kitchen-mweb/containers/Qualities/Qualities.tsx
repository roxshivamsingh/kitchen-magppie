...
const Qualities = () => {
    ...
    return (
        <div className="bg-[#1E1E1E] w-full text-white py-10">
            ...
            <div className="grid grid-cols-2 gap-1 max-w-2xl mx-auto container place-items-center">
                {data.map((card) => {
                    return (
                        <div
                            key={card.id}
                        ...
                        >
                            ...
                            <img
                                src={card.img}
                                alt="Sample"
                                className={`absolute top-0 left-0 w-full h-full object-cover rounded-xl transition-opacity duration-1000 ${hoveredCard === card.id
                                    ? 'opacity-80'
                                    : 'opacity-0'
                                    }`}
                            />
