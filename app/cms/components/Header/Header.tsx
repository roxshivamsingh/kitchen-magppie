...
export default function Header() {
    ...
    if (user.value) {
        return (
            <nav className="bg-white border-gray-200 border-b-2 fixed left-0 right-0 z-20 mb-20">
                        ...
                        <div>
                            ...
                            >
                                <button
                                    ...
                                    type="button"
                                    className="text-white bg-purple-700 hover:bg-purple-800 focus:outline-none focus:ring-4 focus:ring-purple-300 font-medium rounded-full text-sm p-1 py-1 text-center mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900"
                                >
                                    <MdLogout
